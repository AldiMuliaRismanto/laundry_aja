...
<form action="{{route('Transaksi.addTransaksi')}}" method="POST">
    @csrf
    <div class="content">
        <div class="row">
            <div class="col-6">
    ...
    <div class="input-group mb-3">
        <div class="input-group-prepend">
             <span class="input-group-text" id="">Jumlah</span>
                ...
                <input type="" name="the_amount_of_goods" class="form-control" placeholder="" aria-label="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
  ...
  <div class="input-group mb-3">
    <div class="input-group-prepend">
         <span class="input-group-text" id="">Total</span>
            ...
            <input type="number" name="total" class="form-control" placeholder="" aria-label="exampleInputEmail1" aria-describedby="emailHelp">
