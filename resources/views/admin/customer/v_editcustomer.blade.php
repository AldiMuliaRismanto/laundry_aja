...
@section('title','Edit Customer | Laundry Aja')
      ...
      <div class="input-group mb-3">
        <div class="input-group-prepend">
             <span class="input-group-text" id="name">No Telepon</span>
                ...
                <input type="text" name="telephone" class="form-control" placeholder="Masukkan No Telephone" value="{{ old('telephone') ?? $customer->telephone}}" aria-label="exampleInputEmail1" aria-describedby="emailHelp">
</div>
